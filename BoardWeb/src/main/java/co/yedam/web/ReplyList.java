...
public class ReplyList implements Control {
	...
	public void exec(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		//Gson gson = new GsonBuilder().create(); //gson 객체를 생성하는 방식 / Gson 문자열을 만들어서 반환,
		Gson gson = new GsonBuilder().setPrettyPrinting().create();  //gson 객체를 생성하는 방식 / Gson 문자열을 만들어서 반환, setPrettyPrinting 추가시 깔끔하게 정렬해서 출력
